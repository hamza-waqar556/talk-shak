    ...
    return (
        <div>
            <div className="mb-4 lg:mb-5 flex items-center justify-center border border-border-color bg-second-bg-color focus-within:border-primary-color rounded-lg">
                <input type="text" className="bg-transparent placeholder:text-white focus-visible:border-none focus-visible:outline-none w-full p-3 pe-0 " placeholder="Search Channels.... " />
