        ...
        <>
            <div className="bg-[#F5FFFE] py-8">
                <div className="container px-4 md:w-md lg:w-lg xl:w-xl">
                    <div className={`flex relative h-[500px] overflow-hidden rounded-2xl shadow-lg bg-white ${isRightPanelActive ? "right-panel-active" : ""}`}>
                        <div className={`w-full  relative h-full flex items-center justify-center bg-white transition-all ease-in-out duration-700 transform ${isRightPanelActive ? "translate-x-full" : ""}`}>
                            <div className={`w-2/4 left-0 h-full p-8 flex items-center flex-col justify-center bg-white absolute transition-all ease-in-out duration-700 transform ${isRightPanelActive ? "-translate-x-full opacity-0 z-0" : "translate-x-0 opacity-100 z-[3]"}`}>
                                <SignInForm />
                            </div>
                            <div className={`w-2/4 left-0 h-full p-8 flex items-center flex-col justify-center bg-white absolute transition-all ease-in-out duration-700 transform ${isRightPanelActive ? "-translate-x-full opacity-100 z-[5] animate-showForm" : "translate-x-0 opacity-0 z-[1] animate-hideForm"}`}>
                                <SignUpForm />
                            </div>
                        </div>
                        <div className={`w-2/4 absolute right-0 h-full overflow-hidden bg-theme-gradient transition-all ease-in-out duration-700 transform ${isRightPanelActive ? "-translate-x-full" : ""}`}>
